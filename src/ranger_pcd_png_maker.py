...
class Convert:
    def __init__(self):
        ...
        # ouster lidar points
        # self.lidar_sub = rospy.Subscriber("/ranger_rgb_node/ouster/points2", PointCloud2, self.lidar_cb)
        ...
        self.camera_camera_info_sub = rospy.Subscriber("/camera/color/camera_info", CameraInfo,self.camera_info_cb)        
        # robot_pose txt
        self.f = open("/home/kimm/new_ranger5/txt/fastlio_txt.txt", 'w')
    ...
    def lidar_cb(self, msg):
        ...
        if self.lidar_points :
            # pcl.save(self.lidar_points,"/home/kimm/new_ranger5/pcd/%s.pcd"% str(rospy.get_rostime()))
            pcl.save(self.lidar_points,"/home/kimm/new_ranger5/pcd/%s.pcd"% str(self.camera_info.header.stamp))
    ...
    def color_camera_cb(self, msg):
        ...
        # cv2.imwrite("/home/kimm/new_ranger5/img/%s.png"% str(rospy.get_rostime()), self.color_cv2_img)
        cv2.imwrite("/home/kimm/new_ranger5/img/%s.png"% str(self.camera_info.header.stamp), self.color_cv2_img)
